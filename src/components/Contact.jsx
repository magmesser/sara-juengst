    ...
    <div name="contact" className="w-full h-screen bg-[#274C77]  flex justify-center items-center p-4">
      {/* Contact Form */}
        <form action='https://getform.io/f/d62448d4-c8e1-4d6e-9921-e9506ece99b8' method='POST' className='flex flex-col max-w-[600px] w-full'>
            ...
            <input className='p-2 bg-[#A3CEF1] rounded-md' type="text" placeholder='Name' name='name' required/>
            <input className='my-4 p-2 bg-[#A3CEF1] rounded-md' type="email" placeholder='Email' name='email' required/>
            <textarea className='p-2 bg-[#A3CEF1] rounded-md'name="message" rows="10" placeholder='Message' required></textarea>
