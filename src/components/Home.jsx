    ...
    <div name="home" className="w-full h-screen bg-[#274C77]">
      ...
      <div className="max-w-[1000px] mx-auto px-8 flex flex-col justify-center h-full">
        ...
        <h2 className="text-4xl sm:text-7xl font-bold text-[#6096BA]">
          I'm an Associate Professor at UNCC.
        </h2>
        <p className="text-[#A3CEF1] py-4 max-w-[700px]">
          I specialize in bioarchaeology and Andean archaeology. I am
        ...
        <div>
          <button className="text-[#E7ECEF] group border-2 px-6 py-3 my-2 flex items-center hover:bg-[#6096BA] hover:border-[#6096BA]">
            View Work
