...
const newsLinks = [
    {
        id: 1, 
        year: 2022,
        title: "Interviewed and featured in the Lincoln Times News regarding the Mt. Vernon Rosenwald School excavation",
    ...
    },
    {
        id: 2, 
        year: 2021,
        title: "Expert Commenter, The Scientist magazine regarding article “Computed tomography study of the mummy of King Seqenenre Taa II: New insights into his violent death”",
    ...
    },
    {
        id: 4, 
        year: 2020,
        title: "Research referenced in Smithsonian Magazine coverage of child burials from India",
        link: "https://www.sciencefocus.com/news/babies-from-ancient-ecuador-found-wearing-the-skulls-of-other-children-as-helmets/",
    },
    {
        id: 5, 
        year: 2019,
        title: "Research on unique Ecuadorian burials ranked “second most fascinating find of 2019” by Smithsonian  Magazine",
        link: "https://www.smithsonianmag.com/history/twelve-fascinating-finds-revealed-2019-180973837/",
    },
    {
        id: 6, 
        year: 2019,
        title: "Research on unique Ecuadorian burials ranked as one of the “Top 10 Biggest Archaeological Discoveries of 2019” by LiveScience",
        link: "https://www.livescience.com/biggest-archaeology-discoveries-2019.html",
    },
    {
        id: 7, 
        year: 2019,
        title: "Research on unique Ecuadorian burials featured on the Washington Post",
    ...
    },
    {
        id: 8, 
        year: 2019,
        title: "Research on unique Ecuadorian burials featured in Smithsonian Magazine",
        link: "https://www.smithsonianmag.com/smart-news/remains-infants-found-wearing-helmets-made-skulls-other-children-180973608/",
    },
    {
        id: 9, 
        year: 2019,
        title: "Research on unique Ecuadorian burials featured on BBC Science Focus",
        link: "https://www.sciencefocus.com/news/babies-from-ancient-ecuador-found-wearing-the-skulls-of-other-children-as-helmets/",
    },
    {
        id: 10, 
        year: 2019,
        title: "Research on unique Ecuadorian burials featured on Gizmodo en Español",
        link: "https://es.gizmodo.com/nadie-sabe-por-que-estos-bebes-fueron-enterrados-usando-1839976062",
    },
    {
        id: 11, 
        year: 2019,
        title: "Research on unique Ecuadorian burials featured in the Charlotte Observer",
...
const News = () => {
  return (
    ...
    <div className="container max-w-[1000px] mx-auto flex flex-col justify-center w-full h-full text-[#E7ECEF] text-2xl font-bold">
      ...
      >
        {newsLinks.map(({ id, year, title, link }, index) => {
          return (
